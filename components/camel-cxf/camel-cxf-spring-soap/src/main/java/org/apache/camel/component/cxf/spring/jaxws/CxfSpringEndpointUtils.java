...
public final class CxfSpringEndpointUtils {
    private static final Logger LOG = LoggerFactory.getLogger(CxfSpringEndpointUtils.class);

    private CxfSpringEndpointUtils() {
        // not constructed
    }
