...
// components: START
Number of Components: 353 in 268 JAR artifacts (19 deprecated)
...
| link:camel-arangodb/src/main/docs/arangodb-component.adoc[ArangoDb] (camel-arangodb) +
...
| link:camel-djl/src/main/docs/djl-component.adoc[Deep Java Library] (camel-djl) +
...
| link:camel-dynamic-router/src/main/docs/dynamic-router-component.adoc[Dynamic Router] (camel-dynamic-router) +
`dynamic-router:channel` | 3.15 | The Dynamic Router component routes exchanges to recipients, and the recipients (and their rules) may change at runtime.
...
`elasticsearch:clusterName` | 3.19 | Send requests to ElasticSearch via Java Client API.
...
| link:camel-etcd3/src/main/docs/etcd3-component.adoc[Etcd v3] (camel-etcd3) +
`etcd3:path` | 3.19 | Get, set, delete or watch keys in etcd key-value store.
...
| link:camel-graphql/src/main/docs/graphql-component.adoc[GraphQL] (camel-graphql) +
...
| link:camel-hashicorp-vault/src/main/docs/hashicorp-vault-component.adoc[Hashicorp Vault] (camel-hashicorp-vault) +
`hashicorp-vault:secretsEngine` | 3.18 | Manage secrets in Hashicorp Vault Service
...
| link:camel-influxdb2/src/main/docs/influxdb2-component.adoc[InfluxDB2] (camel-influxdb2) +
`influxdb2:connectionBean` | 3.20 | Interact with InfluxDB v2, a time series database.
...
| link:camel-jsonata/src/main/docs/jsonata-component.adoc[JSONata] (camel-jsonata) +
`jsonata:resourceUri` | 3.5 | Transforms JSON payload using JSONata transformation.

| link:camel-json-patch/src/main/docs/json-patch-component.adoc[JsonPatch] (camel-json-patch) +
`json-patch:resourceUri` | 3.12 | Transforms JSON using JSON patch (RFC 6902).
...
| link:camel-kamelet/src/main/docs/kamelet-component.adoc[Kamelet] (camel-kamelet) +
...
| link:camel-mapstruct/src/main/docs/mapstruct-component.adoc[MapStruct] (camel-mapstruct) +
`mapstruct:className` | 3.19 | Type Conversion using Mapstruct
...
| link:camel-minio/src/main/docs/minio-component.adoc[Minio] (camel-minio) +
...
| link:camel-nitrite/src/main/docs/nitrite-component.adoc[Nitrite] (camel-nitrite) +
...
| link:camel-oaipmh/src/main/docs/oaipmh-component.adoc[OAI-PMH] (camel-oaipmh) +
...
| link:camel-opensearch/src/main/docs/opensearch-component.adoc[OpenSearch] (camel-opensearch) +
`opensearch:clusterName` | 4.0 | Send requests to OpenSearch via Java Client API.
...
| link:camel-paho-mqtt5/src/main/docs/paho-mqtt5-component.adoc[Paho MQTT 5] (camel-paho-mqtt5) +
`paho-mqtt5:topic` | 3.8 | Communicate with MQTT message brokers using Eclipse Paho MQTT v5 Client.
...
| link:camel-platform-http/src/main/docs/platform-http-component.adoc[Platform HTTP] (camel-platform-http) +
`platform-http:path` | 3.0 | Expose HTTP endpoints using the HTTP server available in the current platform.

| link:camel-plc4x/src/main/docs/plc4x-component.adoc[PLC4X] (camel-plc4x) +
`plc4x:driver` | 3.20 | Read and write to PLC devices
...
`rest-api:path` | 2.16 | Expose OpenAPI Specification of the REST services defined using Camel REST DSL.
...
| link:camel-rocketmq/src/main/docs/rocketmq-component.adoc[RocketMQ] (camel-rocketmq) +
`rocketmq:topicName` | 3.20 | Send and receive messages from RocketMQ cluster.
...
| link:camel-splunk-hec/src/main/docs/splunk-hec-component.adoc[Splunk HEC] (camel-splunk-hec) +
`splunk-hec:splunkURL/token` | 3.3 | The splunk component allows to publish events in Splunk using the HTTP Event Collector.
...
| link:camel-spring-jdbc/src/main/docs/spring-jdbc-component.adoc[Spring JDBC] (camel-spring-jdbc) +
...
| link:camel-spring-rabbitmq/src/main/docs/spring-rabbitmq-component.adoc[Spring RabbitMQ] (camel-spring-rabbitmq) +
`spring-rabbitmq:exchangeName` | 3.8 | Send and receive messages from RabbitMQ using Spring RabbitMQ client.
...
| link:camel-stitch/src/main/docs/stitch-component.adoc[Stitch] (camel-stitch) +
`stitch:tableName` | 3.8 | Stitch is a cloud ETL service that integrates various data sources into a central data warehouse through various integrations.
...
| link:camel-whatsapp/src/main/docs/whatsapp-component.adoc[WhatsApp] (camel-whatsapp) +
`whatsapp:phoneNumberId` | 3.19 | Send messages to WhatsApp.
...
| link:camel-workday/src/main/docs/workday-component.adoc[Workday] (camel-workday) +
...
| link:camel-xslt-saxon/src/main/docs/xslt-saxon-component.adoc[XSLT Saxon] (camel-xslt-saxon) +
...
| link:camel-zeebe/src/main/docs/zeebe-component.adoc[Zeebe] (camel-zeebe) +
`zeebe:operationName` | 3.21 | Zeebe component which does integrage with Camunda Zeebe to interact with the API.
...
// dataformats: START
Number of Data Formats: 60 in 48 JAR artifacts (3 deprecated)
...
| link:camel-jackson-avro/src/main/docs/avroJackson-dataformat.adoc[Avro Jackson] (camel-jackson-avro) | 3.10 | Marshal POJOs to Avro and back using Jackson.
...
| link:camel-cbor/src/main/docs/cbor-dataformat.adoc[CBOR] (camel-cbor) | 3.0 | Unmarshal a CBOR payload to POJO and back.
...
| link:camel-grok/src/main/docs/grok-dataformat.adoc[Grok] (camel-grok) | 3.0 | Unmarshal unstructured data to objects using Logstash based Grok patterns.
...
| link:camel-zip-deflater/src/main/docs/gzipDeflater-dataformat.adoc[GZip Deflater] (camel-zip-deflater) | 2.0 | Compress and decompress messages using java.util.zip.GZIPStream.
...
| link:camel-jsonb/src/main/docs/jsonb-dataformat.adoc[JSON JSON-B] (camel-jsonb) | 3.7 | Marshal POJOs to JSON and back using JSON-B.
...
| link:camel-jsonapi/src/main/docs/jsonApi-dataformat.adoc[JSonApi] (camel-jsonapi) | 3.0 | Marshal and unmarshal JSON:API resources using JSONAPI-Converter library.
...
| link:camel-parquet-avro/src/main/docs/parquetAvro-dataformat.adoc[Parquet File] (camel-parquet-avro) | 4.0 | Parquet Avro serialization and de-serialization.
...
| link:camel-jackson-protobuf/src/main/docs/protobufJackson-dataformat.adoc[Protobuf Jackson] (camel-jackson-protobuf) | 3.10 | Marshal POJOs to Protobuf and back using Jackson.
...
| link:camel-swift/src/main/docs/swiftMt-dataformat.adoc[SWIFT MT] (camel-swift) | 3.20 | Encode and decode SWIFT MT messages.

| link:camel-swift/src/main/docs/swiftMx-dataformat.adoc[SWIFT MX] (camel-swift) | 3.20 | Encode and decode SWIFT MX messages.
...
| link:camel-zip-deflater/src/main/docs/zipDeflater-dataformat.adoc[Zip Deflater] (camel-zip-deflater) | 2.12 | Compress and decompress streams using java.util.zip.Deflater and java.util.zip.Inflater.
...
// languages: START
Number of Languages: 28 in 18 JAR artifacts (6 deprecated)

[width="100%",cols="4,1,5",options="header"]
|===
| Language | Available From | Description

| link:camel-bean/src/main/docs/bean-language.adoc[Bean Method] (camel-bean) | 1.3 | Calls a Java bean method.
...
| link:camel-datasonnet/src/main/docs/datasonnet-language.adoc[DataSonnet] (camel-datasonnet) | 3.7 | To use DataSonnet scripts for message transformations.
...
| link:camel-javascript/src/main/docs/js-language.adoc[JavaScript] (camel-javascript) | 3.20 | Evaluates a JavaScript expression.

| link:camel-joor/src/main/docs/joor-language.adoc[jOOR] (camel-joor) | 3.7 | Evaluates a jOOR (Java compiled once at runtime) expression.

| link:camel-jq/src/main/docs/jq-language.adoc[JQ] (camel-jq) | 3.18 | Evaluates a JQ expression against a JSON message body.
...
| link:camel-xpath/src/main/docs/xpath-language.adoc[XPath] (camel-xpath) | 1.1 | Evaluates an XPath expression against an XML payload.
...
// others: START
Number of Miscellaneous Components: 70 in 70 JAR artifacts (14 deprecated)

[width="100%",cols="4,1,5",options="header"]
|===
| Component | Available From | Description

| link:camel-attachments/src/main/docs/attachments.adoc[Attachments] (camel-attachments) | 3.0 | Support for attachments on Camel messages
...
| link:camel-cloudevents/src/main/docs/cloudevents.adoc[Cloudevents] (camel-cloudevents) | 3.15 | Camel support for the CloudEvents specification

| link:camel-csimple-joor/src/main/docs/csimple-joor.adoc[CSimple jOOR] (camel-csimple-joor) | 3.7 | jOOR compiler for csimple language
...
| link:camel-debug/src/main/docs/debug.adoc[Debug] (camel-debug) | 3.15 | Enables Camel Route Debugging
...
| link:camel-elytron/src/main/docs/elytron.adoc[Elytron] (camel-elytron) | 3.1 | *deprecated* Elytron Security Provider for camel-undertow
...
| link:camel-http-base/src/main/docs/http-base.adoc[Http Base] (camel-http-base) | 3.1 | Camel HTTP base
...
| link:camel-jfr/src/main/docs/jfr.adoc[JFR] (camel-jfr) | 3.8 | Diagnose Camel applications with Java Flight Recorder

| link:camel-jta/src/main/docs/jta.adoc[JTA] (camel-jta) | 3.4 | Using Camel With JTA Transaction Manager
...
| link:camel-mail-microsoft-oauth/src/main/docs/mail-microsoft-oauth.adoc[Mail Microsoft Oauth] (camel-mail-microsoft-oauth) | 3.18.4 | Camel Mail OAuth2 Authenticator for Microsoft Exchange Online

| link:camel-observation/src/main/docs/observation.adoc[Micrometer Observability] (camel-observation) | 3.21 | Observability using Micrometer Observation
...
| link:camel-opentelemetry/src/main/docs/opentelemetry.adoc[OpenTelemetry] (camel-opentelemetry) | 3.5 | Distributed tracing using OpenTelemetry
...
| link:camel-platform-http-main/src/main/docs/platform-http-main.adoc[Platform Http Main] (camel-platform-http-main) | 4.0 | Platform HTTP for standalone Camel Main applications

| link:camel-platform-http-vertx/src/main/docs/platform-http-vertx.adoc[Platform Http Vertx] (camel-platform-http-vertx) | 3.2 | Implementation of the Platform HTTP Engine based on Vert.x Web

| link:camel-reactive-executor-tomcat/src/main/docs/reactive-executor-tomcat.adoc[Reactive Executor Tomcat] (camel-reactive-executor-tomcat) | 3.17 | Reactive Executor for camel-core using Apache Tomcat

| link:camel-reactive-executor-vertx/src/main/docs/reactive-executor-vertx.adoc[Reactive Executor Vert.x] (camel-reactive-executor-vertx) | 3.0 | Reactive Executor for camel-core using Vert.x
...
| link:camel-redis/src/main/docs/redis.adoc[Redis] (camel-redis) | 3.5 | Aggregation repository using Redis as datastore

| link:camel-resilience4j/src/main/docs/resilience4j.adoc[Resilience4j] (camel-resilience4j) | 3.0 | Circuit Breaker EIP using Resilience4j

| link:camel-resourceresolver-github/src/main/docs/resourceresolver-github.adoc[Resourceresolver Github] (camel-resourceresolver-github) | 3.11 | Resource resolver to load files from GitHub
...
| link:camel-spring-main/src/main/docs/spring-main.adoc[Spring Main] (camel-spring-main) | 3.2 | Camel Spring Main support
...
| link:camel-spring-xml/src/main/docs/spring-xml.adoc[Spring XML] (camel-spring-xml) | 3.9 | Camel Spring with XML DSL
...
| link:camel-threadpoolfactory-vertx/src/main/docs/threadpoolfactory-vertx.adoc[ThreadPoolFactory Vert.x] (camel-threadpoolfactory-vertx) | 3.5 | ThreadPoolFactory for camel-core using Vert.x

| link:camel-tracing/src/main/docs/tracing.adoc[Tracing] (camel-tracing) | 3.5 | Distributed tracing common interfaces
...
| link:camel-wal/src/main/docs/wal.adoc[Write Ahead Log Strategy for Resume API] (camel-wal) | 3.20 | Write Ahead Log Strategy for Resume API
