...
https://www.redhat.com[Red Hat] offers a https://developers.redhat.com/products/red-hat-build-of-apache-camel/overview[supported build of Camel]. 
...
https://developers.redhat.com/products/red-hat-build-of-apache-camel/overview[a developer community].
